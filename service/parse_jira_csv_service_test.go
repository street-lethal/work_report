...
func Test_parseJiraCSVService_Parse(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			args: args{
				csv: [][]string{
					{"イシューキー", "イシューの概要", "時間", "作業日"},
					{"ticket-1", "", "0.25", "2023-01-01 10:00"},
					{"ticket-1", "", "0.25", "2023-01-02 10:00"},
					{"ticket-1", "", "0.75", "2023-01-02 10:00"},
					{"ticket-1", "", "0.25", "2023-01-05 10:00"},
					{"ticket-2", "", "0.5", "2023-01-02 10:00"},
					{"ticket-2", "", "0.5", "2023-01-03 10:00"},
					{"ticket-3", "", "1.0", "2023-01-05 10:00"},
					{"ticket-3", "", "1.0", "2023-01-07 10:00"},
				},
			},
			want: map[int]model.Work{
				1: {
